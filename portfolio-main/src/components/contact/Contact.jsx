        ...
        <div className='contact__content'>
          ...
          <div className='contact__info'>
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>t.nilufar06@gmail.com</span>
              <a
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>+998 91 447 66 71</span>
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>@Nilufar_Hamzaevna</span>
              <a href='https://t.me/solyadev' className='contact__button'>
                Write me
                <i className='bx bx-right-arrow-alt contact__button-icon'></i>
              </a>
